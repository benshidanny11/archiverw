                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">Register admnistrative leader</div>
                                    <div class="card-body">
                                        <form action="regleaderaction.php" method="post">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1"> Leader names</label>
                                                <input type="text" id="cc-pament" name="leadername" class="form-control" placeholder="Enter leader name" required />
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    data.map((strucure) => {
                        ...
                        optiondata.innerHTML = `${strucure.name} (${strucure.from} - ${strucure.to})`;
