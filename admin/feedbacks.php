            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="active">
                            <a href="feedbacks.php"><<i class="fas fa-comment-dots"></i>Feedbacks</a>
                        </li>
                                            ...
                                            <tbody>
                                                ...
                                                if ($result->num_rows > 0) {
                                                    while ($row = $result->fetch_assoc()) {
                                                        echo $row['document']?'<tr>
                                                        <td>'.$row['fullname'].'</td>
                                                        <td>'.$row['emailaddress'].'</td>
                                                        <td>'.$row['phonenumber'].'</td>
                                                        <td>'.$row['feedbackmessage'].'</td>
                                                        <td><a href="'.$row['document'].'">Download<a></td>
                                                        <td>'.$row['doneon'].'</td>
                                                        <td><a href="delfeed.php?id='.$row['id'].'" class="btn btn-danger"><i class="fas fa-trash"></i> Delete</a></td>
                                                    </tr>':'<tr>
                                                    <td>'.$row['fullname'].'</td>
                                                    <td>'.$row['emailaddress'].'</td>
                                                    <td>'.$row['phonenumber'].'</td>
