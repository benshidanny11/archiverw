      ...
      <div class="main-content">
        <div class="section__content section__content--p30">
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12">
                <div class="overview-wrap">
                  <h2 class="title-1">Administration Structures</h2>
                  <a class="au-btn au-btn-icon au-btn--blue" href="registerstructre.php">
                    <i class="zmdi zmdi-plus"></i>Add Structure
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <label for="floatingSelect">Please choose TimeLine to view Structures</label>
                ...
                <div class="card">
                  ...
                  <h5 class="card-header" id="empty">
                    Structures for selected time line
                  </h5>

                  <div class="card-body">
                    <ul class="list-group" id="structreitem"></ul>
                    <p id="btn"></p>
                  </div>
                </div>
              </div>
    ...
    $(document).ready(function() {
      $.ajax({
        ...
        success: function(data) {
          ...
          $("#spfromto").html("from "+data[0].from+" to "+data[0].to);
          ...
          $.ajax({
            url: "dbfiles/timelinestructures.php?timelineid=" + data[0].id,
            method: "GET",
            dataType: "json",
            success: function(structredata) {
              var itemdata = "";
              $.each(structredata, function(index, row) {

                itemdata += "<li class='list-group-item d-flex justify-content-between align-items-center'>" + row.name + "<a href='editstructure.php?id=" + row.id + "'" + "class='btn btn-primary'><i class='fas fa-edit'></i></a>" + "</li>";

              });
              $("#structreitem").html(itemdata);
            },
            error: function(err) {
              console.log(err);
            },
      ...
      $("#choosetimeline").change(function() {
        ...
        var timeline=document.getElementById("choosetimeline");

        console.log(timeline)
       // $("#spfromto").html(timeline);

        $.ajax({
          type: 'GET', //THIS NEEDS TO BE GET
          url: "dbfiles/timelinestructures.php?timelineid=" + period,
          dataType: 'json',
