                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">History document registration</div>
                                    <div class="card-body">
                                        <form action="regbookaction.php" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Document status</label>
                                                <textarea type="text" id="cc-pament" name="status" class="form-control" placeholder="Enter document status" required rows="5"></textarea>

                                            </div>

                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Person in charge contacts</label>
                                                <input type="text" id="cc-pament" name="personincharge" class="form-control" placeholder="Enter contacts of person in charge" required />

                                            </div>

                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">Book owner (Institution)</label>
                                                <input type="text" id="cc-pament" name="bookowner" class="form-control" placeholder="Enter contacts of person in charge" required />

                                            </div>

                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1"> Document location</label>
                                                <input type="text" id="cc-pament" name="location" class="form-control" placeholder="Enter document location" required />

                                            </div>
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1"> Document location latitude</label>
                                                <input type="text" id="cc-pament" name="latitude" class="form-control" placeholder="Enter document location latitude" required />

                                            </div>
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1"> Document location longitude</label>
                                                <input type="text" id="cc-pament" name="longitude" class="form-control" placeholder="Enter document location longitude" required />

                                            </div>
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1"> Document image</label>
                                                <input type="file" id="cc-pament" name="image" class="form-control" required />
