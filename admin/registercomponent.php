        ...
        <nav class="navbar-sidebar">
          <ul class="list-unstyled navbar__list">
            ...
            <li class="disabled" style="pointer-events: none;">
              <a href="#"><i class="fas fa-users"></i>Leaders</a>
            </li>
            <li class="">
        ...
        <div class="section__content section__content--p30">
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-md-12">
                <div class="overview-wrap">
                  <a class="au-btn au-btn-icon au-btn--blue" href="index.php">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">Register admnistrative level</div>
                  <div class="card-body">
                    <form action="addcomponentaction.php" method="post">
                      <div class="form-group">
                        ...
                        <select id="parentlevelstructre" name="parentlevelstructre" class="form-control" required>
                          <option selected>Select parent structure</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select id="levelstructre" name="levelstructre" class="form-control" required>
                          <option selected>Select level structure</option>
                        </select>
                      ...
                      <div class="form-group">
                        ...
                        <select id="parentlevel" name="parentlevel" class="form-control" aria-label="Default select example" required>
                          <option selected>Select parent level</option>
                        </select>

                      </div>
                      <div class="form-group">
                        <label for="cc-payment" class="control-label mb-1"> Level name</label>
                        <input type="text" id="cc-pament" name="levelname" class="form-control" placeholder="Enter level name" required />
