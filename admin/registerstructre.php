                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">Register admnistrative structure</div>
                                    <div class="card-body">
                                        <form action="regstructreaction.php" method="post">
                                            <div class="form-group">
                                                <label for="parentlevelstructre" class="control-label mb-1">Parent structre</label>
                                            ...
                                            <div class="form-group">
                                                <label for="levelstructre" class="control-label mb-1">Time line</label>
