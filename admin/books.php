                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Books of history</h2>
                                    <a class="au-btn au-btn-icon au-btn--blue" href="registerbook.php">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <h4 class="card-title">History documents and their location</h4>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                            ...
                                            <tbody>
                                                ...
                                                if ($result->num_rows > 0) {
                                                    while ($row = $result->fetch_assoc()) {
                                                        echo '<tr>
                                                        <td><img src="uploads/' . $row['image'] . '" width="50" height="50" class="bookimage"></td>
                                                        <td>' . $row['status'] . '</td>
                                                        <td>' . $row['person_incharge_contact'] . '</td>
                                                        <td>' . $row['bookowner'] . '</td>
                                                        <td>' . $row['location'] . '</td>
                                                        <td>Lat:' . $row['latitude'] . ',Long: ' . $row['longitude'] . '</td>
                                                        <td><a href="editbook.php?id=' . $row['id'] . '" class="btn btn-primary"><i class="far fa-edit"></i> Edit</a></td>
                                                    </tr>';
                                                    }
                                                }
