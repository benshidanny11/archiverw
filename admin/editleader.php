...
$sql = "SELECT `leaders`.id,`leaders`.name,leaders.componentId,components.name as compname,date_from,`leaders`.dateto, `structures`.name as strname FROM `leaders` INNER JOIN `components` ON `leaders`.`componentId` = `components`.`id` INNER JOIN structures on components.structureId = structures.id WHERE leaders.id=" . $_GET['id'] . " LIMIT 1";
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="limelines.php"> <i class="far fa-clock"></i>Time lines</a>
                        </li>
                        <li>
                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <button class="au-btn au-btn-icon au-btn--blue" id="btnleaderback">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header">Edit admnistrative leader, if you want to change level first select its strucure</div>
                                    <div class="card-body">
                                        <form action="editleaderaction.php?id=<?php echo $_GET['id'] ?>" method="post">
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1"> Leader names</label>
                                                <input type="text" id="cc-pament" name="leadername" class="form-control" placeholder="Enter leader name" value="<?php echo $row['name'] ?>" required />

                                            </div>
                                            <div class="form-group">
                                                <label for="parentlevelstructre" class="control-label mb-1">Level structre</label>
                                                <select id="parentlevelstructre" name="parentstr" class="form-control" required>
                                            ...
                                            <div class="form-group">
                                                <label for="parentlevel" class="control-label mb-1">Level</label>
                                                <select id="parentlevel" name="componentid" class="form-control" aria-label="Default select example" required>
                                                    <option value="<?php echo $row['componentId'] ?>"><?php echo $row['compname'] ?></option>
                                                </select>

                                            </div>
                                            <div class="form-group">
                                                <label for="parentlevel" class="control-label mb-1">Date from</label>
                                                <input type="text" id="datefrom" name="datefrom" class="form-control" value="<?php echo $row['date_from'] ?>" required />


                                            </div>
                                            <div class="form-group">
                                                <label for="parentlevel" class="control-label mb-1">Date to</label>
                                                <input type="text" id="dateto" name="dateto" class="form-control" value="<?php echo $row['dateto'] ?>" required />
...
<body class="animsition">
    ...
    <script type="text/javascript">
        ...
        document.getElementById("btnleaderback").addEventListener("click", () => {
            window.history.back();
        })
    </script>
</body>
